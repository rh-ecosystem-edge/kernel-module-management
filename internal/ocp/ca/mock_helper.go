...
//
//	mockgen -source=helper.go -package=ca -destination=mock_helper.go
//
...
func (mr *MockHelperMockRecorder) GetClusterCA(ctx, namespace any) *gomock.Call {
...
func (mr *MockHelperMockRecorder) GetServiceCA(ctx, namespace any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockHelperMockRecorder) Sync(ctx, namespace, owner any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
