...
var _ = Describe("validateDRA", func() {
	...
	It("should reject startupProbe on initContainer", func() {
		...
		Expect(validateDRA(mod, minValidOCPVersion)).To(MatchError(ContainSubstring("spec.dra.initContainer.startupProbe is not supported")))
	})
	...
	It("should reject livenessProbe on initContainer", func() {
		...
		Expect(validateDRA(mod, minValidOCPVersion)).To(MatchError(ContainSubstring("spec.dra.initContainer.livenessProbe is not supported")))
	})
