...
// PreflightValidationValidator validates PreflightValidationOCP resources.
...
func (v *PreflightValidationValidator) SetupWebhookWithManager(mgr ctrl.Manager, pf *kmmv1beta2.PreflightValidationOCP) error {
...
//+kubebuilder:webhook:path=/validate-kmm-sigs-x-k8s-io-v1beta2-preflightvalidationocp,mutating=false,failurePolicy=fail,sideEffects=None,groups=kmm.sigs.x-k8s.io,resources=preflightvalidationsocp,verbs=create;update,versions=v1beta2,name=vpreflightvalidationocp.kb.io,admissionReviewVersions=v1
...
func validatePreflight(pv *kmmv1beta2.PreflightValidationOCP) (admission.Warnings, error) {
