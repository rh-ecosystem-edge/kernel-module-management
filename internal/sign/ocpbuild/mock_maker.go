...
func (m *MockMaker) MakeBuildTemplate(ctx context.Context, mld *api.ModuleLoaderData, imageToSign string, pushImage bool, owner v10.Object) (*v1.Build, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "MakeBuildTemplate", ctx, mld, imageToSign, pushImage, owner)
...
func (mr *MockMakerMockRecorder) MakeBuildTemplate(ctx, mld, imageToSign, pushImage, owner interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "MakeBuildTemplate", reflect.TypeOf((*MockMaker)(nil).MakeBuildTemplate), ctx, mld, imageToSign, pushImage, owner)
}
