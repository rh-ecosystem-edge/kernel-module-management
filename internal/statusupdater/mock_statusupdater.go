...
func (mr *MockPreflightStatusUpdaterMockRecorder) PreflightPresetStatuses(ctx, pv, existingModules, newModules any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPreflightStatusUpdaterMockRecorder) PreflightSetVerificationStage(ctx, preflight, moduleName, stage any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPreflightStatusUpdaterMockRecorder) PreflightSetVerificationStatus(ctx, preflight, moduleName, verificationStatus, message any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPreflightOCPStatusUpdaterMockRecorder) PreflightOCPUpdateStatus(ctx, pvo, pv any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
