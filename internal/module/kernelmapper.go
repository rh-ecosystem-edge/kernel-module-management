...
type KernelMapper interface {
	FindMappingForKernel(mappings []kmmv1alpha1.KernelMapping, kernelVersion string) (*kmmv1alpha1.KernelMapping, error)
	GetNodeOSConfig(node *v1.Node) *NodeOSConfig
	PrepareKernelMapping(mapping *kmmv1alpha1.KernelMapping, osConfig *NodeOSConfig) (*kmmv1alpha1.KernelMapping, error)
}
...
func (k *kernelMapper) FindMappingForKernel(mappings []kmmv1alpha1.KernelMapping, kernelVersion string) (*kmmv1alpha1.KernelMapping, error) {
...
func (k *kernelMapper) PrepareKernelMapping(mapping *kmmv1alpha1.KernelMapping, osConfig *NodeOSConfig) (*kmmv1alpha1.KernelMapping, error) {
