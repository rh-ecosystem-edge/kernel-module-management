...
var _ = Describe("ModuleReconciler_getRequestedModule", func() {
	...
	BeforeEach(func() {
		...
		mnrh = newModuleNMCReconcilerHelper(clnt, nil, nil, nil)
	})
...
var _ = Describe("ModuleReconciler_setFinalizer", func() {
	var (
		ctrl *gomock.Controller
		clnt *client.MockClient
		mnrh moduleNMCReconcilerHelperAPI
...
var _ = Describe("finalizeModule", func() {
	...
	BeforeEach(func() {
		...
		mnrh = newModuleNMCReconcilerHelper(clnt, nil, helper, nil)
		mod = &kmmv1beta1.Module{
...
var _ = Describe("shouldModuleRunOnNode", func() {
	...
	BeforeEach(func() {
		mnrh = newModuleNMCReconcilerHelper(nil, nil, nil, nil)
...
var _ = Describe("enableModuleOnNode", func() {
	...
	BeforeEach(func() {
		...
		mnrh = newModuleNMCReconcilerHelper(clnt, rgst, helper, authFactory)
		kernelVersion = "some version"
		nodeName = "node name"
		ctx = context.Background()
		mld = &api.ModuleLoaderData{
